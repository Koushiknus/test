...
public class FacebookController<FacebookApi> {
	...
	public String postOnWall(@RequestParam("code") String code,
		...
		FacebookProfile facebookProfile = template.userOperations()
				.getUserProfile();
		System.out.println("FacebookProfileEmail"+facebookProfile.getEmail());
		System.out.println("FacebookProfileUserName"+facebookProfile.getUsername());
		System.out.println("FacebookProfileFullName"+facebookProfile.getName());
